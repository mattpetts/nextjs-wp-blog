            ...
            <div className="w-8/12 py-8 m-auto">
                {post._embedded['wp:featuredmedia'][0].source_url &&
                    <img 
                        ...
                        className="rounded-md block mx-auto mt-6 max-w-5xl" 
                    />
                }
                <h1 className="w-max text-left break-normal font-main font-bold text-5xl text-left my-6 relative blog-hover text-white">
                ...
                <div className="flex flex-row align-center border-t border-b py-4 mb-5 dark:border-gray-800">
                    <h4 className="font-main font-bold text-md mr-5 dark:text-white">Last Updated: {formatDate}</h4>
                    <h4 className="font-main font-bold text-md dark:text-white">By: {post._embedded.author[0].name}</h4>
                </div>
                <div
